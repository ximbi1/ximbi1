...
- <img src="https://cultofthepartyparrot.com/parrots/hd/githubparrot.gif" width="25" height="25"/> **Supaterm**  *(en desarrollo)* 
  **La terminal del futuro, potenciada con IA.**  
  ...
  - 🤖 **Asistente de IA Avanzado**  
    ...
    - Revisión de configuraciones (`package.json`, `webpack`, `tsconfig`).  
    - Generación automática de código, documentación, tests y scripts de automatización.  
...
---
- <img src="https://cultofthepartyparrot.com/parrots/hd/scienceparrot.gif" width="25" height="25"/> **Neurocode IDE** *(en desarrollo)* 
  **Un IDE inteligente inspirado en Cursor, pero con ADN propio.**  
  ...
  Basado en Monaco, combina las mejores ideas de Cursor.dev con nuevas funciones de **memoria persistente** y colaboración **multi-agente**.  

  ### ✨ Funcionalidades principales
  - 🧠 **IA con memoria persistente de proyecto**: recuerda conversaciones previas, el contexto de cada archivo y tus decisiones pasadas.  
...
- <img src="https://cultofthepartyparrot.com/parrots/hd/meldparrot.gif" width="25" height="25"/> **DevopsHub**  
**El centro de mando definitivo para DevOps.**  
  ...
  Construido con **React, TypeScript y Tailwind CSS**, ofrece una interfaz moderna, responsiva y pensada para **controlar clusters, automatizar tareas y resolver problemas en tiempo real**.  

  ### ✨ Secciones principales
  - 🏠 **Dashboard**: métricas clave de sistemas, uptime, recursos y accesos rápidos.  
  - 📈 **Monitoring System**: métricas en vivo (CPU, memoria, red, logs), estado de servicios (APIs, DB, Redis) y clusters Kubernetes/Proxmox.  
  - ☸️ **Kubernetes Management**: conexión con `kubeconfig`, visualización de nodos, pods y eventos en tiempo real.  
  - 🔍 **Testing & Validation Tools**: ping, traceroute, DNS lookup, validación SSL, HTTP testing, con histórico de resultados.  
  ...
  - 🤖 **AI Assistant**: copiloto especializado en DevOps, capaz de generar comandos (`kubectl`, `docker`, `bash`), analizar errores, proponer best practices y guiar troubleshooting en vivo.  
  - 🖥️ **Proxmox Management**: monitorización de nodos PVE y PBS, consumo de CPU/RAM, accesos rápidos a la GUI y comandos CLI integrados.  
...
- <img src="https://cultofthepartyparrot.com/parrots/hd/footballparrot.gif" width="25" height="25"/> **PDU-Checker**  
  ...
  **PDU-Checker** es una herramienta automatizada que asegura la **disponibilidad energética** mediante chequeos periódicos, alertas inmediatas y acciones correctivas automáticas.  

  ### 🔌 ¿Qué hace?
  - ✅ **Supervisión automática de PDUs**: chequea disponibilidad, estado y respuesta de cada unidad.  
...
- <img src="https://cultofthepartyparrot.com/parrots/hd/scienceparrot.gif" width="25" height="25"/> **SparkAI**  
  **El constructor de apps inteligente.**  
  ...
  A diferencia de generadores de código desordenados o prompts sueltos, SparkAI actúa como un **orquestador de proyectos completo**: entiende lo que quieres, lo organiza en fases y te acompaña en cada paso hasta que tienes un producto funcional.  

  ### 🔥 ¿Cómo funciona?
  - 📝 **Definición en lenguaje natural**: describes tu idea de aplicación con palabras simples (ej: *“quiero una app de gestión de tareas con usuarios, login y calendario”*).  
  ...
  ### 🧩 Diferenciadores frente a otros builders
  ...
  Es como tener un **equipo completo (PM + arquitecto + dev senior)** dentro de una sola herramienta, trabajando contigo en tiempo real.  

  En resumen: **un app builder inteligente, ordenado y escalable, con editor propio y conectado a GitHub para que tus proyectos no se queden en pruebas, sino que crezcan como software real.**
...
- <img src="https://cultofthepartyparrot.com/parrots/hd/moonwalkingparrot.gif" width="25" height="25"/> **DreamPixel Studio**  
  **El dashboard definitivo para crear juegos con IA.**  
  ...
  Más que un simple generador, es un **hub centralizado** donde gestionas proyectos, editas código, pruebas tus juegos y generas assets de manera organizada.  

  ### 🖥️ El Dashboard
  - 📂 **Gestión de Proyectos**: cada juego se organiza en su propio espacio, con carpetas dedicadas para código, assets, configuraciones y builds.  
